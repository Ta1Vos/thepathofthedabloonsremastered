 ...
 */
final class Version20240611102511 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE effect ADD affected_player_property VARCHAR(255) DEFAULT NULL, ADD effect_value_severity INT NOT NULL, DROP debuff_severity');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('CREATE TABLE property_changes (id INT AUTO_INCREMENT NOT NULL, player_property VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, change_value INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('ALTER TABLE effect ADD debuff_severity VARCHAR(10) NOT NULL, DROP affected_player_property, DROP effect_value_severity');
    }
}
